...
class BiMPM(object):
    def __init__(self, config):
        ...
        # if is_training: match_representation = tf.nn.dropout(match_representation, (1 - config.dropout_rate))
    ...
    def add_train_op(self, loss):
        ...
        with tf.name_scope('train_op'):
            ...
            if self.config.lambda_l2 > 0.0:
                ...
                loss = loss + self.config.lambda_l2 * l2_loss
    ...
    def highway_layer(self, in_val, output_size, scope=None):
        ...
        in_val = tf.reshape(in_val, [batch_size * length, output_size])
        ...
        outputs = tf.reshape(outputs, [batch_size, length, output_size])
        return outputs
